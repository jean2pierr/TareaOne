            ...
            try 
            {
                ...
                if (!string.IsNullOrEmpty(txtUsuario.Text.Trim()) && !string.IsNullOrEmpty(txtClave.Text.Trim()))
                {
                    ...
                    if (resultado != null)
                    {
                        ...
                        Toast.MakeText(this, "¡Inicio exitoso!", ToastLength.Short).Show();
                    ...
                    {
                        Toast.MakeText(this, "¡Nombre de usuario o clave no es correcto!", ToastLength.Long).Show();
                    }
                }
                else
                {
                    Toast.MakeText(this, "Nombre de usuario o clave vacios", ToastLength.Long).Show();
                }
